...
class MyGame(Game):
    def __init__(self, canonize=False) -> None:
        super().__init__()
    ...
    def move(self, from_pos: tuple[int, int], slide: Move, player_id: int) -> bool:
        ...
        if acceptable:
            if self.canonize:
                self.set_board(canonize(self.get_board()))
    ...
    def get_board_hashable(self):
        return tuple(map(tuple,self.get_board()))